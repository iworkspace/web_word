    ...
    return a.extend(b.prototype, {
        ...
        next: function() {
            (this.options.continuous || this.index < this.num - 1) && this.slide(this.index + 1)
				var word = $("div[data-index="+this.index+"]").children('img').attr("src")
				word = word.split("/")
				if(word.length>=1){
		...
		gen_title_content: function(b) {
			var content = b.replaceAll("\n","</br>")
			var p = document.createElement("p")
			p.className = ".rainblow_tips_static"
			p.innerHTML = content
			return p
		},
        setTitle: function(a) {
            ...
            b && c[0].appendChild(this.gen_title_content(b)))
        },
        ...
        unloadElements: function(a) {
            ...
            for (b in this.elements)
                this.elements.hasOwnProperty(b) && (c = Math.abs(a - b),
...
function(a) {
    ...
    return a.extend(b.prototype, {
        createIndicator: function(b) {
            ...
            void 0 === c && (d = b.getElementsByTagName && a(b).find("img")[0],
            d && (c = d.src)),
